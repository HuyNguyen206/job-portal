                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @guest
                        ...
                        @if (Route::has('register'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('register') }}">{{ __('Register Seeker') }}</a>
                            </li>
                        @endif

                        @if (Route::has('employer.show-register'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('employer.show-register') }}">{{ __('Register Employer') }}</a>
                            </li>
                        @endif
                    @else
                        @php

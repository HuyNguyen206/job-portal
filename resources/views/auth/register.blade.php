                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input value="male"  type="radio" class="@error('gender') is-invalid @enderror" name="gender" required autocomplete="new-gender">
                                <label for="">Female</label>
                                <input value="female"  type="radio" class=" @error('gender') is-invalid @enderror" name="gender" required autocomplete="new-gender">
                                @error('gender')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
